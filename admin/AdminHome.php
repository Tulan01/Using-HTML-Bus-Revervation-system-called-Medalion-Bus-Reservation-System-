	  ...
	  <div class="adminform-div">
	  		<div style="text-align: right;">
		   			<form action="Register.php" method="get">
		   				...
		   				<input type="submit" value="CreateAdmin" class="create-new-button"/>
		   			</form> 
		   	</div>
		   	<div class="admin-inf-div">
		   			<table>
		   					...
		   					<tr>
		   							...
		   							<td>  <?php echo $age; ?>  </td>
		   							<td>
		   								<a class="button" href="UpdateDelete.php?id=<?php echo $id;?>&action=edit">Edit</a>
		   								<a class="button" href="UpdateDelete.php?id=<?php echo $id;?>&action=delete">Delete</a>
		   							</td>
		   					</tr>
		   					<?php
		   						       }
